...
import { startPlacement, submitPlacement } from "./actions";
import type { PlacementQuestion, PlacementResult } from "@/lib/placement";

type Stage = "pick" | "answering" | "done";
  ...
  if (stage === "pick") {
    return (
      <>
        ...
        {error && <p className="mt-4 text-xs text-[color:var(--state-danger)]">{error}</p>}
      </>
    );
  }
